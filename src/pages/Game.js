...
class Game extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <Header />
        <div className="paiGame">
          { results.length > 0 ? (
            <div className="paiGame2">
              <h1>Timer</h1>
              <p className="timerGame">{ timer }</p>
              <p
                data-testid="question-category"
                className="categoryGame"
              >
                { results[questionOrder].category }
              </p>
              <p
                data-testid="question-text"
                className="questionGame"
              >
                { results[questionOrder].question }
              </p>
              <div data-testid="answer-options" className="answerGame">
